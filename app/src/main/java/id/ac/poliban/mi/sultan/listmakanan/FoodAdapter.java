package id.ac.poliban.mi.sultan.listmakanan;
...
public class FoodAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        img_food = convertView.findViewById(R.id.img_flag);
        tvFoodName = convertView.findViewById(R.id.tv_country_name);
        tvFoodDesc = convertView.findViewById(R.id.tv_country_description);
